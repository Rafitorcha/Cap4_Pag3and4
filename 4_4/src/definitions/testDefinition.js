...
exerciseTable.createTable('nodex','y',)
...
artifactTest.createOneQuestionWithManyInputs('pregunta para responder', false, ['Dominio', '\\left(-\\infty,\\infty\\right)', 'R'], ['Rango', '\\left(-\\infty,\\infty\\right)', 'R']) //se define la pregunta
...
artifactTest.createOneQuestionWithManyInputs("", false, ['Partes positivas', '\\left(-\\infty,0\\right)'], ['Partes negativas', "\\left(0,\\infty\\right)"])
...
questions2.createOneQuestionWithManyInputs('', false, ['Zonas de crecimiento', '\\phi'])
questions2.createOneQuestionWithManyInputs('', false, ['Zonas de decrecimiento', '\\left(-\\infty,\\infty\\right)'])
